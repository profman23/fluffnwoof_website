...
export function FloatingWhatsApp() {
  ...
  return (
    <motion.div
      ...
      className="fixed bottom-8 z-50 end-8"
    >
      <a
        ...
        aria-label="WhatsApp"
        className="whatsapp-float-btn group relative flex h-16 w-16 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-transform duration-200 hover:scale-110"
      >
        {/* Icon */}
